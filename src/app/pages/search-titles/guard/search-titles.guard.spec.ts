...
import { searchTitlesGuard } from './search-titles.guard';

type MockActivatedRouteSnapshot = Partial<ActivatedRouteSnapshot>;
describe('searchTitlesGuard', () => {
  let state: RouterStateSnapshot;
  let router: Router;

  const executeGuard: CanActivateFn = (...guardParameters) =>
    TestBed.runInInjectionContext(() => searchTitlesGuard(...guardParameters));
